...
/**
 * @file
 * API documentation for the node_conversion module.
 */
 ...
 *
 * This will tell CTools which file contains the implementation of hook_node_conversion_change().
 ...
 */
function hook_node_conversion_change($data, $op) {
...
// $containers = variable_get('forum_containers', array());
      ...
      if (in_array($term, $containers)) {
        $term = \Drupal::entityManager()->getStorage("taxonomy_term")->load($term);
 ...
 *   Additional options passed to node_conversion_node_conversion().
 */
function hook_node_conversion_presave($node, $hook_options = array()) {
